...
class V8_EXPORT String : public Name {
 public:
  ...
  static V8_WARN_UNUSED_RESULT MaybeLocal<String> NewFromUtf8(
      ...
      NewStringType type = NewStringType::kNormalString, int length = -1);
...
class V8_EXPORT Object : public Value {
 public:
  ...
  V8_WARN_UNUSED_RESULT MaybeLocal<Value> Get(
                                              Local<Value> key);

  V8_WARN_UNUSED_RESULT MaybeLocal<Value> Get( uint32_t index);
...
void Template::Set(Isolate* isolate, const char* name, Local<Data> value) {
  Set(String::NewFromUtf8(isolate, name, String::NewStringType::kInternalizedString)
          .ToLocalChecked(),
      value);
}
